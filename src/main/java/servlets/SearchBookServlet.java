		...
		try {
			...
			while (rs.next()) {
				...
				htmlBuilder.append("<div class='col-md-4 mb-4'>")
						...
						.append("<a href='bookDetails.jsp?bookId=").append(bookId).append("'>").append("<img src='")
						.append(src).append("' class='card-img-top' alt='Book Image' style='height:600px;' />")
						.append("</a>").append("<div class='card-body'>").append("<div class='text-center'>")
						.append("<a href='bookDetails.jsp?bookId=").append(bookId)
						.append("' style='text-decoration: none; color:#0C243C;'>")
						.append("<h4 class='card-title fw-bold'>").append(title).append("</h4>").append("</a>")
						.append("</div>")
						.append("<p class='text-center mb-2' style='text-decoration: none; color:#0C243C;'>")
						.append(category).append(" | S$").append(price).append("</p>").append("</div>").append("</div>")
						.append("</div>");
